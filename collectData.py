...
routing = "Route: " + path + "\nTravel time (sec): " + str(travelTime)  + "\nTravel distance (m): " + str(travelDist)
...
pchance = weather['precipChance'][0]
ptype = weather['precipType'][0]
temp2 = weather['temperature'][0]
offset = ""
print(routing)
rain = 20
snow = 30
print()
print(f"Flight Time: {time_difference.days} days, {hours} hours, {minutes} minutes, {seconds} seconds")
print()
...
departure_datetime = arrival_date - datetime.timedelta(seconds=estimatedDT)
departure_time = rest_hours - datetime.timedelta(seconds=estimatedDT)
